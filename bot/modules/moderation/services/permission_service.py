...
MODERATION_ACTIONS: tuple[ModerationActionSpec, ...] = (
    ...
    ModerationActionSpec("debate_setup", "Debate Setup", "Debatten-System einrichten", "manage_channels"),
    ModerationActionSpec("debate_panel", "Debate Panel", "Debatten-Panel aktualisieren", "manage_channels"),
    ModerationActionSpec("debate_topic_create", "Debate Topic Create", "Bestätigte Debatten-Themen anlegen", "manage_guild"),
    ModerationActionSpec("debate_topic_approve", "Debate Topic Approve", "Debatten-Themen bestätigen", "manage_guild"),
